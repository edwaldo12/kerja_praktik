                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Pemesan" name="nama_pemesan"
                                        value="{{ $order->nama_pemesan }}" id="nama_pemesan">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="tel" class="form-control" placeholder="" name="nomor_telepon_pemesan"
                                        value="{{ $order->nomor_telepon_pemesan }}" id="nomor_telepon_pemesan">
                                </div>
                ...
                <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input min="1" max="100" type="number" class="form-control" placeholder=""
                                        name="jumlah_pesanan" value="{{ old('jumlah_pesanan') }}" id="jumlah_pesanan">
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <button type="button" class="btn btn-sm btn-success" onclick="updateOrder()">Simpan</button>
                        </div>
                    </div>
                </div>
            </div>
